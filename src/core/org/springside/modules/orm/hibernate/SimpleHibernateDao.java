...
public class SimpleHibernateDao<T, PK extends Serializable> {
	...
	public T findUniqueBy(final String propertyName, final Object value) {
		Assert.hasText(propertyName, "propertyName不能为空");
		Criterion criterion = Restrictions.eq(propertyName, value);
//		Criterion usedCriterion = Restrictions.eq("isUse", "Y");
		return (T) createCriteria(criterion).uniqueResult();
	}

	/**
	 * 按属性查找IS_USE是Y的唯一对象,匹配方式为相等.
	 */
	public T findIsUseUniqueBy(final String propertyName, final Object value) {
		Assert.hasText(propertyName, "propertyName不能为空");
		Criterion criterion = Restrictions.eq(propertyName, value);
		Criterion usedCriterion = Restrictions.eq("isUse", "Y");
		return (T) createCriteria(criterion,usedCriterion).uniqueResult();
	}
	 ...
	 * 依据两个属性判断
	 */
	public T findIsUseUniqueBy(final String propertyName, final String propertyName1, final Object value, final Object value1) {
		...
		return (T) createCriteria(criterion,criterion1,usedCriterion).uniqueResult();
	}
	 ...
	 * @return 更新记录数.
	 */
	public int batchExecuteWithSql(final String sql, final Map<String, ?> values) {
